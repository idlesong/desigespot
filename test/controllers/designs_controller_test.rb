...
class DesignsControllerTest < ActionController::TestCase
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post :create, design: { author: @design.author, household: @design.household, name: @design.name, stage: @design.stage, style: @design.style }
    end
  ...
  test "should update design" do
    patch :update, id: @design, design: { author: @design.author, household: @design.household, name: @design.name, stage: @design.stage, style: @design.style }
    assert_redirected_to design_path(assigns(:design))
  end
